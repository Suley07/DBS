...
const services = [
  ...
  { label: "Hospitality & Receptie", path: "/diensten/hospitality" },
];
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border/50">
      <div className="container flex items-center justify-between h-20">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden md:flex items-center gap-2 ml-2 border-l border-border/50 pl-4">
            <a href="https://wa.me/31611746464" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center hover:bg-primary/20 transition-colors" aria-label="WhatsApp">
              <WhatsAppIcon className="w-4 h-4 text-primary" />
            </a>
            <a href="tel:0611746464" className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center hover:bg-primary/20 transition-colors" aria-label="Bel ons">
              <Phone className="w-4 h-4 text-primary" />
            </a>
            <a href="mailto:info@dienstbewakingensurveillance.nl" className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center hover:bg-primary/20 transition-colors" aria-label="Email">
                ...
                <AnimatePresence>
                  {dropdownOpen && (
                    <motion.div
                      ...
                      className="absolute top-full left-0 mt-3 w-64 bg-card border border-border rounded-xl shadow-2xl overflow-hidden"
                    >
                      <Link
                        to="/diensten"
          ...
          >
            <div className="container py-6 flex flex-col gap-4">
              ...
              <div className="flex items-center gap-3 pb-4 border-b border-border/50">
                <a href="https://wa.me/31611746464" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center" aria-label="WhatsApp">
                  <WhatsAppIcon className="w-5 h-5 text-primary" />
                </a>
                <a href="tel:0611746464" className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center" aria-label="Bel ons">
                  <Phone className="w-5 h-5 text-primary" />
                </a>
                <a href="mailto:info@dienstbewakingensurveillance.nl" className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center" aria-label="Email">
